...
/**
 * OAuthButtons — shared across Login and Signup.
 */
const OAuthButtons = () => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 420, width: '100%', margin: '0 auto' }}>
    ...
    >
      <BtnContent icon={<GoogleIcon size={20} />} label="Continue with Google" />
    </a>
    ...
    >
      <BtnContent icon={<GitHubIcon size={20} color="#FFFFFF" />} label="Continue with GitHub" />
    </a>
    ...
    <a
      ...
      onMouseEnter={e => {
        e.currentTarget.style.background = '#095AAB';
        e.currentTarget.style.transform = 'translateY(-2px)';
    ...
    >
      <BtnContent icon={<LinkedInIcon size={20} color="#FFFFFF" />} label="Continue with LinkedIn" />
    </a>
